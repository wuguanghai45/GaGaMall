...
class Home extends Component {
  ...
  centerItemAction(){
      ...
      InteractionManager.runAfterInteractions(() => {
        navigation.navigate('WebViewDetails');
      });
  }
             ...
             <View style={{marginTop:8}}>
                <View style={{flexDirection:'row',backgroundColor:'white',paddingTop:10,paddingBottom:10}}>
                 <View style={{flex:1,marginLeft:8}}>
                       ...
                       <ImageBackground source={CENTER_IMGS[0]} style={{width:80,height:100}}>
                 ...
                 <View style={{flex:1}}>
                       ...
                       <ImageBackground source={CENTER_IMGS[1]} style={{width:80,height:100}}>
                            <View style={styles.center_item_wrap}>
                 ...
                 <View style={{flex:1}}>
                       ...
                       <ImageBackground source={CENTER_IMGS[2]} style={{width:80,height:100}}>
                            <View style={styles.center_item_wrap}>
                 ...
                 <View style={{flex:1}}>
                       ...
                       <ImageBackground source={CENTER_IMGS[3]} style={{width:80,height:100}}>
                            <View style={styles.center_item_wrap}>
